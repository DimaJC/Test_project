...
const ToDOList = () => {
    ...
    return (
        <div>
            <div>
                <input onChange={handleChange} value={text} placeholder="Напиши мне что-то"/>
                <button onClick={addTextInTodo}>
                    Добавить текст
                </button>
            </div>
            <div>
                {todos.map((item) => {
                    return (editTodo === item.id ?
                        (
                            <div>
                                <input type="text" placeholder={item.text} value={editText} onChange={handleEditText}/>
                            ...
                            <div>
                                ...
                                <button onClick={() => henldeRemoveItem(item.id)}>Удалить!</button>
                            </div>
                        )
                    )
                })}
